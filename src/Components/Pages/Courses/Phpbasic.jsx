...
import { FaArrowLeft, FaCode, FaDatabase, FaProjectDiagram, FaFilePdf } from "react-icons/fa";

const Phpbasic = () => {
  const pdfPath = "/php.pdf"; // Path to your PDF file in the public folder
  const modules = [
    { title: "PHP Basics", details: "Syntax, Variables, Data Types, Operators", icon: <FaCode className="w-8 h-8" /> },
    { title: "Control Structures", details: "Loops, Conditionals, Functions", icon: <FaCode className="w-8 h-8" /> },
    { title: "Form Handling", details: "GET & POST, Form Validation, Sessions & Cookies", icon: <FaCode className="w-8 h-8" /> },
    { title: "Database Integration", details: "MySQL, PDO, CRUD Operations", icon: <FaDatabase className="w-8 h-8" /> },
    { title: "Object-Oriented PHP", details: "Classes, Objects, Inheritance, Interfaces", icon: <FaCode className="w-8 h-8" /> },
    { title: "PHP Security", details: "Sanitization, Validation, Preventing SQL Injection", icon: <FaDatabase className="w-8 h-8" /> },
    { title: "Capstone Project", details: "Building a Simple CMS or E-commerce Website", icon: <FaProjectDiagram className="w-8 h-8" /> },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-r from-blue-300 to-purple-300 p-4 sm:p-6">
      <div className="bg-white shadow-2xl rounded-lg p-6 sm:p-8 max-w-4xl w-full text-center">
        {/* Course Title */}
        <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4">PHP Basic Roadmap</h1>
        <p className="text-base sm:text-lg text-gray-700 max-w-2xl mx-auto">
          Learn PHP fundamentals, database integration, security, and object-oriented programming.
        </p>
