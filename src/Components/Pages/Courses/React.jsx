...
const ReactCourse = () => {
  const pdfPath = "/ReactJS (1).pdf"; // Path to your PDF file in the public folder
  const modules = [
    { title: "React Basics", details: "JSX, Components, Props, State", icon: <FaCode className="w-8 h-8" /> },
    { title: "React Hooks", details: "useState, useEffect, useContext", icon: <FaCode className="w-8 h-8" /> },
    { title: "React Router", details: "Routing, Nested Routes, Dynamic Routes", icon: <FaCogs className="w-8 h-8" /> },
    { title: "State Management", details: "Context API, Redux, Zustand", icon: <FaCode className="w-8 h-8" /> },
    { title: "Backend Integration", details: "REST APIs, GraphQL, Axios, Fetch API", icon: <FaDatabase className="w-8 h-8" /> },
    { title: "Performance Optimization", details: "Lazy Loading, Memoization, Virtual DOM", icon: <FaCloud className="w-8 h-8" /> },
    { title: "Testing & Debugging", details: "Jest, React Testing Library, Chrome DevTools", icon: <FaCloud className="w-8 h-8" /> },
    { title: "Capstone Project", details: "End-to-End React Application Development", icon: <FaProjectDiagram className="w-8 h-8" /> },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-r from-blue-300 to-purple-300 p-4 sm:p-6">
      <div className="bg-white shadow-2xl rounded-lg p-6 sm:p-8 max-w-4xl w-full text-center">
        {/* Course Title */}
        <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4">React.js Roadmap</h1>
        <p className="text-base sm:text-lg text-gray-700 max-w-2xl mx-auto">
          Master frontend development with React.js, Hooks, Routing, State Management, and Performance Optimization.
        </p>
