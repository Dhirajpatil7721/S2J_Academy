...
const PythonBasics = () => {
  const pdfPath = "/Python.pdf"; // Path to the PDF file

  const modules = [
    { title: "Python Basics", details: "Variables, Data Types, Operators, Control Flow", icon: <FaCode className="w-8 h-8" /> },
    { title: "Functions & Modules", details: "Defining Functions, Lambda, Importing Modules", icon: <FaCogs className="w-8 h-8" /> },
    ...
    { title: "Data Structures", details: "Lists, Tuples, Dictionaries, Sets", icon: <FaTasks className="w-8 h-8" /> },
    { title: "Regular Expressions", details: "Pattern Matching, re Module", icon: <FaCogs className="w-8 h-8" /> },
    { title: "Database Connectivity", details: "SQLite, MySQL, PostgreSQL with Python", icon: <FaDatabase className="w-8 h-8" /> },
    { title: "Unit Testing in Python", details: "Unittest, Pytest Framework", icon: <FaTasks className="w-8 h-8" /> },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-r from-blue-300 to-purple-300 p-4 sm:p-6">
      <div className="bg-white shadow-2xl rounded-lg p-6 sm:p-8 max-w-4xl w-full text-center">
        {/* Course Title */}
        <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4">Python Basics Roadmap</h1>
        <p className="text-base sm:text-lg text-gray-700 max-w-2xl mx-auto">
          Master Python fundamentals including OOP, File Handling, Data Structures, and Database Connectivity.
        </p>
